...
--
-- Host: localhost    Database: teste_idealizza
-- ------------------------------------------------------
...
CREATE TABLE `cobrancas` (
  ...
  CONSTRAINT `cobrancas_aluno_id_foreign` FOREIGN KEY (`aluno_id`) REFERENCES `alunos` (`id`)
...
-- Dump completed on 2018-08-27 19:28:39
